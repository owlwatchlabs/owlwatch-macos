...
_M5.3 (System Extensions + Configuration Profiles + Kernel extensions), M5.4 (cron + periodic + login/logout hooks), M5.5 (macOS app UI), and M5-close follow under this Unreleased section before the v0.6.0-m5 tag._
