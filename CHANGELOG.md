...
_M5.2 (login items + System Extensions + Configuration Profiles), M5.3 (kernel extensions + cron + login/logout hooks), M5.4 (macOS app UI for the persistence view), and M5-close follow under this Unreleased section before the v0.6.0-m5 tag._
